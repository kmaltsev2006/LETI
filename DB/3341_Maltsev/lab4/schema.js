...
const Driver = sequelize.define(
    ...
    },
    {
        ...
        indexes: [
            {
                name: 'idx_driver_experience',
                fields: ['experience']  // Для сортировки в query8
            }
        ]
    }
);
...
const Bus = sequelize.define(
    ...
    },
    {
        ...
        indexes: [
            {
                name: 'idx_bus_type',
                fields: ['bus_type_id']  // Для JOIN с BusType
            }
        ]
    }
);
...
const Route = sequelize.define(
    ...
    },
    {
        ...
        indexes: [
            {
                name: 'idx_route_start_point',
                fields: ['start_point']  // Для query10
            },
            {
                name: 'idx_route_end_point', 
                fields: ['end_point']  // Для query10
            }
        ]
    }
);
